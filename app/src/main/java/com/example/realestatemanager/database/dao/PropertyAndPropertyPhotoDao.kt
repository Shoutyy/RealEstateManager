...
interface PropertyAndPropertyPhotoDao {
    ...
    @Query("SELECT * FROM PropertyAndPropertyPhoto INNER JOIN PropertyPhoto ON PropertyAndPropertyPhoto.propertyPhotoId = PropertyPhoto.property_photo_id WHERE :isThisTheIllustration = PropertyPhoto.isThisTheIllustration")
    fun getIllustrationPropertyPhotos(isThisTheIllustration: Boolean): LiveData<List<PropertyAndPropertyPhoto>>
